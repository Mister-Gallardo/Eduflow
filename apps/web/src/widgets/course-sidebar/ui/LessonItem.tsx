...
import { useSidebarAction } from '../lib'
import type { NavigationLesson } from '../model'

import { lessonStyles, lessonTitleStyles, tooltipTextSecondaryStyles } from './CourseSidebar.styles'
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {isFullyCompleted ? (
            <CheckCircleIcon sx={{ fontSize: 18, display: 'block', color: 'success.main' }} />
          ) : (
            <CircularProgress
              variant="determinate"
              value={totalSteps > 0 ? (completedSteps / totalSteps) * 100 : 0}
              ...
              sx={{
                color: hasProgress ? 'primary.main' : 'divider',
              }}
            />
          )}
        </Box>
